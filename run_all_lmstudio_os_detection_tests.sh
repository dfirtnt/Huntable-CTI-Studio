#!/bin/bash
# Test OS detection agent with all specified LMStudio models
...
MODELS=(
    ...
    # "SEC-BERT"                          # Not supported in LMStudio - requires separate implementation
)

echo "=================================================================================="
echo "LMStudio OS Detection Agent Benchmark - Testing All Models"
echo "=================================================================================="
echo ""
...
for model in "${MODELS[@]}"; do
    ...
    export LMSTUDIO_MODEL_OS_DETECTION="$model"
    python3 score_os_detection_lmstudio.py
