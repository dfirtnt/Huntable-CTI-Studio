...
class TestSigmaRule:
    ...
    def test_init_valid_rule(self):
        ...
        rule_data = {
            ...
            "detection": {"selection": {"CommandLine": "test.exe"}, "condition": "selection"},
            "level": "medium",
        }
    ...
    def test_validate_required_fields(self):
        ...
        # Missing detection
        rule_data = {"title": "Test Rule", "description": "A test rule", "logsource": {"category": "process_creation"}}
    ...
    def test_validate_detection(self):
        ...
        rule_data_no_condition = {
            "title": "Test Rule",
            "logsource": {"category": "process_creation"},
            "detection": {"selection": {"CommandLine": "test.exe"}},
        }
...
class TestSigmaValidator:
    ...
    def test_validate_rule_complex_detection(self, validator):
        ...
        rule_data = {
            ...
            "detection": {
                ...
                "selection2": {"CommandLine": "*-EncodedCommand*"},
    ...
    def test_validate_rule_with_falsepositives(self, validator):
        ...
        rule_data = {
            ...
            "detection": {"selection": {}, "condition": "selection"},
            "level": "medium",
            "falsepositives": ["Legitimate administrative tasks", "Software installation"],
        }
    ...
    def test_validation_result_creation(self):
        ...
        result = ValidationResult(
            is_valid=True, errors=["Error 1", "Error 2"], warnings=["Warning 1"], metadata={"test": "value"}
        )
