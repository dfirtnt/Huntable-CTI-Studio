...
from src.services.deduplication import AsyncDeduplicationService, DeduplicationService
from src.utils.simhash import SimHash, compute_article_simhash, is_content_similar
...
class TestDeduplicationService:
    ...
    def test_create_article_with_deduplication_exact_duplicate(
        self, deduplication_service, sample_article, mock_session
    ):
...
class TestAsyncDeduplicationService:
    ...
    @pytest.mark.asyncio
    async def test_check_exact_duplicates_by_content_hash(
        self, async_deduplication_service, sample_article, mock_async_session
    ):
        """Test exact duplicate checking by content hash."""
        # Mock existing article by content hash
        existing_article = Mock(spec=ArticleTable)
    ...
    @pytest.mark.asyncio
    async def test_check_exact_duplicates_no_duplicate(
        self, async_deduplication_service, sample_article, mock_async_session
    ):
        """Test exact duplicate checking with no duplicates."""
    ...
    @pytest.mark.asyncio
    async def test_check_near_duplicates_decimal_conversion(
        self, async_deduplication_service, sample_article, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_article_with_deduplication_exact_duplicate(
        self, async_deduplication_service, sample_article, mock_async_session
    ):
        """Test article creation with exact duplicate."""
        # Mock exact duplicate found
    ...
    @pytest.mark.asyncio
    async def test_create_article_with_deduplication_new_article(
        self, async_deduplication_service, sample_article, mock_async_session
    ):
        """Test article creation with new article."""
