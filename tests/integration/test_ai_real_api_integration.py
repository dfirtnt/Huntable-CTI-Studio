...
class TestAIRealAPIIntegration:
    ...
    @pytest.mark.ai
    @pytest.mark.asyncio
    async def test_openai_gpt4o_real_api_call(self, sample_threat_article, openai_api_key):
    ...
    @pytest.mark.ai
    @pytest.mark.asyncio
    async def test_anthropic_claude_real_api_call(self, sample_threat_article, anthropic_api_key):
    ...
    async def test_api_timeout_handling(self, sample_threat_article, openai_api_key):
        ...
        payload = {
            ...
            'messages': [
                {
                    'role': 'user',
                    'content': sample_threat_article['content'][:1000]
                }
            ],
            'max_tokens': 100
        }
    ...
    async def test_end_to_end_ai_workflow_real_apis(self, sample_threat_article, openai_api_key):
        ...
        try:
            ...
            optimization_result = {'success': False, 'filtered_content': sample_threat_article['content']}
