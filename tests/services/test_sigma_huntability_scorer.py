...
from src.services.sigma_huntability_scorer import HuntabilityScore, SigmaHuntabilityScorer
...
"""
    ...
    def test_assess_false_positive_risk(self, scorer):
        ...
        detection_low = {
            "selection": {"CommandLine|contains|all": ["powershell", "-encodedcommand", "base64"]},
            "condition": "selection",
        }

        # High risk: very generic
        detection_high = {"selection": {"CommandLine|contains": "exe"}, "condition": "selection"}
