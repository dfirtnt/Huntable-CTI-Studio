...
def extract_prompt_from_js(html_content: str, function_name: str) -> Optional[str]:
    """
...
class TestPromptSynchronization:
    ...
    def test_all_ranking_prompts_exclude_atomic_iocs(self):
        ...
        for prompt_name in ranking_prompts:
            ...
            has_exclusion = (
                'do not award points for atomic iocs' in prompt or
                'do not award points' in prompt or
                'atomic ioc' in prompt or
                'single domains' in prompt
            )
    ...
    def test_ranking_prompt_files_have_consistent_structure(self):
        ...
        for name, content in prompts.items():
            ...
            assert (
                'atomic ioc' in content_lower or
                'single domains' in content_lower or
                'do not award points' in content_lower
