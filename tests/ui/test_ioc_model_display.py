"""Test IOC display behavior with different AI models (Claude, LMStudio, etc.)."""
                ...
                if ioc_modal.is_visible(timeout=10000):
                    ...
                    if generation_area.is_visible():
                        ...
                        if llm_checkbox.is_visible():
                            ...
                            if not is_checked:
                                if "Generated by" in generation_text or any(model in generation_text.lower() for model in ['gpt', 'claude', 'lmstudio', 'anthropic']):
                                ...
                                test_models = [
                                    ...
                                    {'ai_model': 'lmstudio', 'expected': 'lmstudio'},
