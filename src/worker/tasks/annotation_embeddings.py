                    ...
                    for annotation in batch:
                        try:
                            ...
                            await db.update_annotation_embedding(
                                annotation_id=annotation.id, embedding=embedding, model_name="all-mpnet-base-v2"
                            )
    ...
    try:
        ...
        async def run_single_annotation_embedding():
            ...
            try:
                ...
                await db.update_annotation_embedding(
                    annotation_id=annotation_id, embedding=embedding, model_name="all-mpnet-base-v2"
                )
        ...
        async def run_batch_annotation_embedding():
            ...
            try:
                ...
                for i in range(0, len(annotation_ids), batch_size):
                    ...
                    annotations_to_process = [annotation for annotation in annotations if annotation.embedding is None]
                ...
                logger.info(
                    f"Batch annotation embedding complete: {total_processed} processed, {total_skipped} skipped, {total_errors} errors"
                )
                return {
                    "status": "success",
