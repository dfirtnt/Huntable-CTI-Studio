...
async def api_os_detection_manual_results():
    ...
    try:
        ...
        if multi_model_eval_path.exists():
            with open(multi_model_eval_path, 'r') as f:
        ...
        accuracies = {}
        model_columns = ['gemini', 'sonnet_4_5', 'haiku_4_5', 'chatgpt4o', 'chatgpt5_1', 'sec_bert', 
                        'cti_bert', 'deepseek_r1', 'qwen2_7b', 'qwen3_4b', 'llama_3_1_8b', 'llama_3_8b',
                        'llama_3_13b', 'llama_3_3_70b', 'phi_3_mini', 'llama_3_2_1b', 'mistral_7b', 'mixtral_8x7b']
...
async def api_observables_count_results():
    ...
    try:
        ...
        model_summaries = defaultdict(lambda: {
            'total_articles': 0,
            'successful_parses': 0,
            'failed_parses': 0,
        ...
        try:
            ...
            for eval_record in history:
                ...
                if eval_record == history[0]:
                    ...
                    eval_db = db_session.query(AgentEvaluationTable).filter(
                        AgentEvaluationTable.id == eval_record['id']
                    ).first()
            ...
            return {
                "success": True,
                "score_distribution": score_distribution_data or {
