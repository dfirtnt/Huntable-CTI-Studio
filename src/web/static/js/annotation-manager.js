/**
 * Robust Text Annotation System for Huntable CTI Studio
 * 
...
class TextAnnotationManager {
    ...
    addAnnotationStyles() {
        ...
        if (typeof window !== 'undefined' && window.getComputedStyle) {
            ...
            if (!v || v.trim() === '') {
                console.warn('[annotation-manager] Theme CSS variables may not be loaded (--text-muted missing). Annotation menu colors may fallback incorrectly.');
            }
        }
    }
}
