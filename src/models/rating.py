...
class ArticleRating(BaseModel):
    ...
    updated_at: Optional[datetime] = Field(None, description="When rating was last updated")
...
class ArticleCategorization(BaseModel):
    ...
    reason: Optional[str] = Field(None, description="Optional reason for categorization")
    created_at: datetime = Field(default_factory=datetime.utcnow, description="When categorization was created")
    updated_at: Optional[datetime] = Field(None, description="When categorization was last updated")
