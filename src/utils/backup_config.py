...
_config_manager: BackupConfigManager | None = None


def get_backup_config(config_file: str | None = None, environment: str | None = None) -> BackupConfig:
...
def get_backup_config_manager(config_file: str | None = None, environment: str | None = None) -> BackupConfigManager:
