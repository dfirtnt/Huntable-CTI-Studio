"""
Integration module for content filtering with LLM ranking.

This module integrates the content filter with LLM ranking systems
to reduce costs by filtering out non-huntable content.

Note: Cost calculations use GPT-4o pricing as a reference estimate.
