...
class ModelEvaluator:
    ...
    def _calculate_metrics(self, y_true: List[str], y_pred: List[str], 
        ...
        metrics = {
            ...
            'not_huntable_avg_confidence': float(np.mean(not_huntable_confidences)) if not_huntable_confidences else 0.0,
    ...
    def find_misclassified_chunks(self, content_filter, 
