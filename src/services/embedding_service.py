...
class EmbeddingService:
    ...
    def __init__(self, model_name: str = "all-mpnet-base-v2", cache_dir: str | None = None):
        """
    ...
    def create_enriched_text(
        ...
        text_parts = [f"Title: {title}", f"Source: {source}"]
...
def generate_article_embedding(
    article_title: str, source_name: str, article_content: str, summary: str = None, tags: list = None
) -> list[float]:
    """
