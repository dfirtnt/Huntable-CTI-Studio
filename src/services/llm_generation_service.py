...
class LLMGenerationService:
    ...
    def _create_rag_prompt(
        ...
        system_prompt = """You are a cybersecurity threat intelligence analyst. Your role is to analyze threat intelligence data and provide synthesized, actionable insights.
