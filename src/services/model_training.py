...
def convert_observable_to_workshop_format(
    ...
    try:
        ...
        if result.returncode != 0:
            ...
            if "Some weights of" in error_msg and "were not initialized" in error_msg:
                ...
                if (model_output_dir / "pytorch_model.bin").exists() or (model_output_dir / "model.safetensors").exists():
