...
class NoveltyResult:
    ...
    closest_match_id: Optional[int] = None
    closest_match_similarity: Optional[float] = None
    closest_match_title: Optional[str] = None
    ...
    def detect_novelty(
        ...
        if db_session:
            ...
            for existing_rule in existing_rules:
                ...
                try:
                    existing_core = self.normalizer.extract_behavioral_core(
                        existing_rule.rule_yaml or ""
                    )
            ...
            if best_match:
                ...
                elif best_similarity >= self.similarity_threshold_variant:
                    return NoveltyResult(
                        novelty_score=1,
