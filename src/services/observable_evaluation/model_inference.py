...
class ObservableModelInference:
    ...
    def __init__(self, model_path: Optional[str] = None, model_name: str = "CMD", model_version: Optional[str] = None):
        """
    ...
    def load_model(self) -> bool:
        ...
        if not self.model_path.exists():
            ...
            logger.error(f"Model may not have been trained yet. Check training logs.")
            return False
    ...
    @staticmethod
    def find_model_path(model_name: str, model_version: Optional[str] = None) -> Optional[Path]:
        """
        ...
        if model_version:
            ...
            for model_key in model_keys:
                ...
                if model_path.exists() and ((model_path / "pytorch_model.bin").exists() or (model_path / "model.safetensors").exists()):
                    return model_path
            ...
            if fallback_path.exists() and ((fallback_path / "pytorch_model.bin").exists() or (fallback_path / "model.safetensors").exists()):
