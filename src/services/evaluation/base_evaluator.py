...
class BaseAgentEvaluator(ABC):
    ...
    @abstractmethod
    async def evaluate_dataset(self, test_data_path: Path, **kwargs) -> dict[str, Any]:
        """
    ...
    def save_results(
        self, output_path: Path | None = None, save_to_db: bool = False, db_session=None
    ) -> dict[str, Any]:
        """
    ...
    def compare_with_baseline(
        self, baseline_metrics: dict[str, Any], current_metrics: dict[str, Any] | None = None
    ) -> dict[str, Any]:
        """
