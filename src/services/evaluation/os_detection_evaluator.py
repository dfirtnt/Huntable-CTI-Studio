...
class OSDetectionEvaluator(BaseAgentEvaluator):
    ...
    async def evaluate_dataset(
        self,
        test_data_path: Path,
        os_detection_service: Optional[OSDetectionService] = None,
        **kwargs
    ) -> Dict[str, Any]:
        """
    ...
    async def _evaluate_article(
        ...
        ground_truth_os: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        try:
            detection_result = await os_detection_service.detect_os(
    ...
    def _evaluate_detection_result(
        ...
        expected_os: Optional[str],
        ground_truth_os: Optional[str],
    ...
    def calculate_metrics(self) -> Dict[str, Any]:
        ...
        ground_truth_accuracies = [
            e['ground_truth_accuracy']
            for e in evaluations
            if e.get('ground_truth_accuracy') is not None
        ]
        ...
        metrics = {
            ...
            'ground_truth_accuracy': sum(ground_truth_accuracies) / len(ground_truth_accuracies) if ground_truth_accuracies else None,
