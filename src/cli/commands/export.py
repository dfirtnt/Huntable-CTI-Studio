...
@pass_context
def export(ctx: CLIContext, output_format: str, days: int, output: str | None, source: str | None):
    ...
    async def _export():
        ...
        try:
            # Build filter
            filter_params = ArticleFilter(published_after=datetime.now() - timedelta(days=days), limit=10000)
