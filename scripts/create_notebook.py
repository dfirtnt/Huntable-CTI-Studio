...
def create_notebook():
    ...
    # Cell 2: Setup
    cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## 1. Setup and Imports"]})
    ...
    cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## 2. Configuration"]})
    ...
    cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## 3. Select Articles to Test"]})
    ...
    cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## 4. Select Models to Test"]})
    ...
    # Add run tests cell
    cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## 8. Run Tests"]})
    ...
    cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## 9. Display Results"]})
    ...
    # Add export cell
    cells.append({"cell_type": "markdown", "metadata": {}, "source": ["## 10. Export Results"]})
