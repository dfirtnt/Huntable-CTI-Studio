...
def analyze_keywords():
    ...
    for article in articles:
        ...
        for keyword in WINDOWS_KEYWORDS:
            ...
            if keyword in ["[.]", "::", "==", "-accepteula"] or keyword in ["c:\\windows\\", "D:\\"]:
    ...
    print("Articles by classification:")
    ...
    for keyword in WINDOWS_KEYWORDS:
        ...
        if chosen_count > 0 and rejected_count == 0 and unclassified_count == 0:
            ...
            print("  ✅ PERFECT DISCRIMINATOR - 100% Chosen, 0% others")
        elif chosen_count > 0 and (rejected_count == 0 or unclassified_count == 0):
            good_discriminators.append(keyword)
            print("  🟡 GOOD DISCRIMINATOR - High Chosen ratio")
        else:
            print("  ❌ Not a good discriminator")
        print()
