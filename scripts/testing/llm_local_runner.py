...
def run_chat(model: str, prompt: str, content: str, lmstudio_url: str = DEFAULT_LMSTUDIO, timeout: float = 30.0) -> Dict[str, Any]:
    payload = {
        "model": model,
        "messages": [
...
def main(argv: List[str] | None = None) -> int:
    ...
    parser.add_argument("--prompts", nargs="+", required=False, help="Prompts to run. If omitted, a default prompt is used.")
