...
from src.services.observable_training import _get_paths, _load_manifest
...
def rollback_last_training(observable_type: str = "CMD", archive: bool = True):
    ...
    try:
        ...
        if len(versions) > 1:
            ...
            print("  No previous version found, set active_version to None")
        ...
        if archive:
            ...
            print("  Files not archived (archive=False)")
        ...
        print("   Removed version from manifest")
        if archive:
            print("   Archived dataset and artifact files")
