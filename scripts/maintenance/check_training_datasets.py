    ...
    try:
        ...
        for dataset_file in training_files[:3]:  # Check most recent 3
            ...
            if gold_found:
                ...
                print(f"  ✅ No gold annotations found in this dataset")
            ...
            if eval_found:
                ...
                print(f"  ✅ No eval annotations found in this dataset")
        ...
        if all_gold_found or all_eval_found:
            print(f"❌ ISSUE CONFIRMED: Gold/eval annotations WERE included in training datasets")
            if all_gold_found:
            ...
            print(f"✅ VERIFIED: No gold/eval annotations found in training datasets")
            print(f"   Training code correctly excludes gold/eval annotations")
