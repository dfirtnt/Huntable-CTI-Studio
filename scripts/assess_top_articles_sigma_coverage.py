...
def main():
    ...
    try:
        ...
        # Track results
        total_assessments = 0
        coverage_summary = {"covered": 0, "extend": 0, "new": 0, "no_matches": 0}
        ...
        for idx, article in enumerate(articles, 1):
            ...
            if not matches:
                ...
                print("   ⚠️  No Sigma matches found")
            else:
                ...
                for match in matches:
                    ...
                    if rule:
                        ...
                        classification = coverage_service.classify_match(
                            article_id=article["id"], sigma_rule=rule, similarity_score=match["similarity_score"]
                        )
                ...
                if (
                    article_coverage["covered"] == 0
                    and article_coverage["extend"] == 0
                    and article_coverage["new"] == 0
                ):
        ...
        new_rules_needed = [
            a for a in article_results if a["coverage"]["covered"] == 0 and a["coverage"]["extend"] == 0
        ]
