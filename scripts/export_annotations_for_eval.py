...
async def export_annotations(
    annotation_types: Iterable[str] | None = None, unused_only: bool = False, output_override: Path | None = None
):
...
def main():
    ...
    success = asyncio.run(export_annotations(annotation_types, args.unused_only, output_path))
