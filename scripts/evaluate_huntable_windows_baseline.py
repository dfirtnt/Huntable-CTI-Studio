...
def baseline_keyword_threshold(training_data: list[dict[str, Any]], threshold: int = 1) -> dict[str, Any]:
...
def baseline_keyword_features_only(
    training_data: list[dict[str, Any]], classifier_type: str = "random_forest"
) -> dict[str, Any]:
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate baseline performance for Windows huntables detection")
