...
async def main():
    ...
    parser.add_argument("--model", type=str, help="Model name/identifier (default: from LLMService config)")
    ...
    evaluator = ExtractAgentEvaluator(model_version=model_name, evaluation_type=args.evaluation_type)
