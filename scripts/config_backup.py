...
try:
    from utils.backup_config import get_backup_config_manager, BackupConfigManager
except ImportError:
...
def sync_with_ui_settings(config_manager: BackupConfigManager, ui_settings_file: Optional[str]) -> None:
