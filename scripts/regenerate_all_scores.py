...
async def regenerate_all_threat_hunting_scores():
    ...
    try:
        ...
        articles_with_score = sum(
            1 for a in updated_articles if a.article_metadata and "threat_hunting_score" in a.article_metadata
        )
        print(
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print(
            f"  Final articles with scores: {result['final_with_score']} ({result['final_with_score'] / result['total_articles'] * 100:.1f}%)"
        )
