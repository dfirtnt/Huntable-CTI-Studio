...
| 5 | `update-provider-model-catalogs-daily` | `update_provider_model_catalogs` | `0 4 * * *` | Daily 04:00 UTC | `maintenance` — refreshes **OpenAI, Anthropic, Gemini** model lists → `config/provider_model_catalog.json` |
