...
- AI: `OPENAI_API_KEY`, `ANTHROPIC_API_KEY`, `CHATGPT_API_KEY`, `LMSTUDIO_API_URL` (default `http://host.docker.internal:1234/v1`), `LMSTUDIO_MODEL` and model-specific overrides. Langfuse tracing via Settings or `LANGFUSE_*` env vars (optional).
