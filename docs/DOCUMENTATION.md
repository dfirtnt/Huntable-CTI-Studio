...
The documentation has been reorganized under `/docs` and published with MkDocs Material. Use the navigation or the links below:
...
Serve locally with `mkdocs serve` to browse the full site.
