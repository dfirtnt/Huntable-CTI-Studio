...
<!-- TODO: fill Significance and Features before merging to main; pull content from docs/CHANGELOG.md [7.9.0] section. -->
- **Named After**: <fill>
- **Significance**: <fill>
- **Features**: <fill>
...
- **Features**:
    ...
    - Content-addressed workflow execution configuration snapshots with PostgreSQL advisory-lock serialization on config writes
