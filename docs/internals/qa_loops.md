...
2. **Encoder classifier**: Filters candidates using embedding similarity against VALID/INVALID exemplars (e.g., Microsoft/CTI-BERT or `all-MiniLM-L6-v2`). Keeps only likely Windows commands.
