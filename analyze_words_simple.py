...
def analyze_articles():
    ...
    with open('/tmp/top_articles.txt', 'r') as f:
        content = f.read()
    
    # Parse the PostgreSQL output (simplified parsing)
    lines = content.split('\n')
    articles = []
    ...
    for line in lines:
        ...
        elif in_content and not line:
            # End of content
            if current_article:
                current_article['content'] = ' '.join(content_lines)
