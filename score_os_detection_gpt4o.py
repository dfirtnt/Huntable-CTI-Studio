#!/usr/bin/env python3
"""Score OS detection performance using GPT-4o with JSON output evaluation."""
...
RESULTS_FILE = "gpt4o_os_detection_scores.json"
...
async def detect_os(article_id: int, title: str, source: str, url: str, content: str, max_retries: int = 3) -> Optional[Dict[str, Any]]:
    """Detect OS from a single article using GPT-4o."""
...
async def main():
    ...
    print(f"Detecting OS from {len(articles)} articles with GPT-4o...\n")
    ...
    for result in results:
        if result:
            ...
            # OpenAI pricing: $2.50/1M input, $10/1M output (GPT-4o)
